...
import logo from './images/bid.jpg'
...
function Login(){
    ...
    return(
        <div className='fullheight'>
            <div id='loginheader' className='loginheader'>ONLINE BIDDING</div>
            <div id='logincontent'>
            ...
            <div id='loginfooter'>Copyright @ ONLINE BIDDING. All rights reserved.</div>
        </div>
    );
}
